...
<!--<p>This page allows you to remove selected filters and update more filters along with your frequency. To add more filters, First select the filters you want to add. Next click your same alert frequency or a new one in the top right. Finally click the "Add Selecetd" button. Follow this same process for 
removing filters but click the "Remove Selected" button instaed. After clicking one of the buttons you will be redirected back to the home page.</p>
-->
<button onclick="addSelection()">Submit Filters</button>
</div>
